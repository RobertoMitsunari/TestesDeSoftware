...
public class REQ03CT01MantemAluno {
	...
	public void rEQ03CT01() {
		...
		driver.findElement(By.id("isbn")).click();driver.findElement(By.id("isbn")).sendKeys("1113");
		...
		driver.findElement(By.id("nome")).sendKeys("AlunoT");
