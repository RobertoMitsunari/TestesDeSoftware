...
public class REQ04CT06MantemAluno {
	...
	public void rEQ04CT07() {
		...
		driver.findElement(By.id("nome")).sendKeys("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb");
		...
		assertThat(driver.findElement(By.cssSelector(".text-danger:nth-child(3)")).getText(),
				is("Nome deve ter entre 1 e 50 caracteres"));
	}
}
